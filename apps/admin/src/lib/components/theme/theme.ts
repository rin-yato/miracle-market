import { localStorageStore } from '$lib/helpers/local-storage-store';
...
export const modeOsPrefers = localStorageStore<boolean>(
  'modeOsPrefers',
  false,
);
...
export const modeCurrent = localStorageStore<boolean>(
  'modeCurrent',
  false,
);
